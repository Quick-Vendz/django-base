...
module.exports = {
  content: [
    ...
    './lessons/templates/**/*.html',
    './assignments/templates/**/*.html',
    './progress/templates/**/*.html',
    './comments/templates/**/*.html',
  ],
  safelist: [
    // Add all possible background colors you'll use for categories
    ...
    // Hover sslate-500', 'hover:bg-slate-700', 'hover:bg-red-500', 'hover:bg-red-700', 'hover:bg-blue-500', 'hover:bg-blue-700', 'hover:bg-green-500', 'hover:bg-green-700', 'hover:bg-yellow-500', 'hover:bg-yellow-700', 'hover:bg-purple-500', 'hover:bg-purple-700', 'hover:bg-pink-500', 'hover:bg-pink-700', 'hover:bg-indigo-500', 'hover:bg-indigo-700', 'hover:bg-orange-500', 'hover:bg-orange-700', 'hover:bg-teal-500', 'hover:bg-teal-700', 'hover:bg-cyan-500', 'hover:bg-cyan-700',
    // Focus-visible outline states
    'focus-visible:outline-slate-600', // Focus-visible outline states
    'focus-visible:outline-red-600', 'focus-visible:outline-blue-600', 'focus-visible:outline-green-600', 'focus-visible:outline-yellow-600', 'focus-visible:outline-purple-600', 'focus-visible:outline-pink-600', 'focus-visible:outline-indigo-600', 'focus-visible:outline-orange-600', 'focus-visible:outline-teal-600', 'focus-visible:outline-cyan-600',
